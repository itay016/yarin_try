...
class MyApp(App):
    ...
    def on_config_change(self, config, section, key, value):
        ...
        """
        Logger.info("main_checks.py: App.on_config_change: {0}, {1}, {2}, {3}".format(
    ...
    def close_settings(self, settings=None):
        ...
        """
        Logger.info("main_checks.py: App.close_settings: {0}".format(settings))
...
class MySettingsWithTabbedPanel(SettingsWithTabbedPanel):
    ...
    """
    def on_close(self):
        Logger.info("main_checks.py: MySettingsWithTabbedPanel.on_close")

    def on_config_change(self, config, section, key, value):
        Logger.info(
            "main_checks.py: MySettingsWithTabbedPanel.on_config_change: "
